...
VkShaderModule renderer::GraphicsPipeline::createShaderModule(VkDevice &device, const std::vector<char> &code) {
...
void renderer::GraphicsPipeline::cleanUp(VkDevice &device) {
...
VkPipeline &renderer::GraphicsPipeline::get() {
    return _graphicsPipeline;
}

VkRenderPass &renderer::GraphicsPipeline::getRenderPass() {
    return _renderPass;
}

VkPipelineLayout &renderer::GraphicsPipeline::getLayout() {
    return _pipelineLayout;
}

VkDescriptorSetLayout &renderer::GraphicsPipeline::getDescriptorSetLayout() {
